...
"use strict";
eval("/* WEBPACK VAR INJECTION */(function(__f__) {Object.defineProperty(exports, \"__esModule\", { value: true });exports.default = void 0;var _regenerator = _interopRequireDefault(__webpack_require__(/*! ./node_modules/@babel/runtime/regenerator */ 41));\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\nvar _storage = _interopRequireDefault(__webpack_require__(/*! ../../utils/storage */ 77));function _interopRequireDefault(obj) {return obj && obj.__esModule ? obj : { default: obj };}function asyncGeneratorStep(gen, resolve, reject, _next, _throw, key, arg) {try {var info = gen[key](arg);var value = info.value;} catch (error) {reject(error);return;}if (info.done) {resolve(value);} else {Promise.resolve(value).then(_next, _throw);}}function _asyncToGenerator(fn) {return function () {var self = this,args = arguments;return new Promise(function (resolve, reject) {var gen = fn.apply(self, args);function _next(value) {asyncGeneratorStep(gen, resolve, reject, _next, _throw, \"next\", value);}function _throw(err) {asyncGeneratorStep(gen, resolve, reject, _next, _throw, \"throw\", err);}_next(undefined);});};}var _default =\n{\n  data: function data() {\n    return {\n      search: '',\n      site: 'zdzyw',\n      siteList: [\n      {\n        label: '最大资源网',\n        value: 'zdzyw' },\n\n      {\n        label: 'OK资源网',\n        value: 'okzyw' }],\n\n\n      type: '',\n      typeList: [],\n      flowList: [],\n      list: [\n      {\n        year: 35,\n        name: '北国风光，千里冰封，万里雪飘',\n        class: '李白杜甫白居易',\n        image: 'http://pic.sc.chinaz.com/Files/pic/pic9/202002/zzpic23327_s.jpg' },\n\n      {\n        year: 75,\n        name: '望长城内外，惟余莽莽',\n        class: '李白杜甫白居易',\n        image: 'http://pic.sc.chinaz.com/Files/pic/pic9/202002/zzpic23325_s.jpg' },\n\n      {\n        year: 385,\n        name: '大河上下，顿失滔滔',\n        class: '李白杜甫白居易',\n        image: 'http://pic2.sc.chinaz.com/Files/pic/pic9/202002/hpic2119_s.jpg' },\n\n      {\n        year: 784,\n        name: '欲与天公试比高',\n        class: '李白杜甫白居易',\n        image: 'http://pic2.sc.chinaz.com/Files/pic/pic9/202002/zzpic23369_s.jpg' },\n\n      {\n        year: 7891,\n        name: '须晴日，看红装素裹，分外妖娆',\n        class: '李白杜甫白居易',\n        image: 'http://pic2.sc.chinaz.com/Files/pic/pic9/202002/hpic2130_s.jpg' },\n\n      {\n        year: 2341,\n        class: '李白杜甫白居易',\n        name: '江山如此多娇，引无数英雄竞折腰',\n        image: 'http://pic1.sc.chinaz.com/Files/pic/pic9/202002/zzpic23346_s.jpg' },\n\n      {\n        year: 661,\n        class: '李白杜甫白居易',\n        name: '惜秦皇汉武，略输文采',\n        image: 'http://pic1.sc.chinaz.com/Files/pic/pic9/202002/zzpic23344_s.jpg' }],\n\n\n      loadStatus: 'loadmore',\n      scrollTop: 0,\n      res: null };\n\n  },\n  methods: {\n    searchEvent: function searchEvent() {var _this = this;return _asyncToGenerator( /*#__PURE__*/_regenerator.default.mark(function _callee() {var arr, lala;return _regenerator.default.wrap(function _callee$(_context) {while (1) {switch (_context.prev = _context.next) {case 0:\n                // const lala = await db.siteGetAll()\n                // console.log(lala, 'lala')\n                // console.log(this.search, 'search');\n                // const doc = {\n                // \tid: 2,\n                // \tkey: 'mahuazy',\n                // \tname: '麻花资源',\n                // \tapi: 'https://www.mhapi123.com/inc/api.php',\n                // \tisActive: true\n                // }\n                arr = ['lala', 'gaga', 'haha', 'papa'];_context.next = 3;return (\n                  _storage.default.siteKeyAdd(arr));case 3:lala = _context.sent;\n                _this.$refs.uTips.show({\n                  title: lala,\n                  type: 'success',\n                  duration: '2000' });\n\n                // console.log(lala)\n                // this.$refs.uTips.show({\n                // \ttitle: 'lala',\n                // \ttype: 'success',\n                // \tduration: '20000'\n                // })\n              case 5:case \"end\":return _context.stop();}}}, _callee);}))();},\n    searchClearEvent: function searchClearEvent() {\n      __f__(\"log\", 'search clear event', \" at pages/film/film.vue:136\");\n    },\n    addRandomData: function addRandomData() {\n      for (var i = 0; i < 10; i++) {\n        var index = this.$u.random(0, this.list.length - 1);\n        // 先转成字符串再转成对象，避免数组对象引用导致数据混乱\n        var item = JSON.parse(JSON.stringify(this.list[index]));\n        item.id = this.$u.guid();\n        this.flowList.push(item);\n      }\n    },\n    dropdownOpen: function dropdownOpen() {\n      this.$refs.uDropdown.highlight();\n    },\n    dropdownClose: function dropdownClose(index) {\n      this.$refs.uDropdown.highlight(index);\n    },\n    openDetail: function openDetail(item) {\n      var url = \"/pages/detail/detail?site=\".concat(this.site, \"&uuid=\").concat(item.id);\n      this.$u.route({ url: url });\n    },\n    getClass: function getClass() {\n      __f__(\"log\", 'get class', \" at pages/film/film.vue:158\");\n    } },\n\n  onPageScroll: function onPageScroll(e) {\n    this.scrollTop = e.scrollTop;\n  },\n  onLoad: function onLoad() {\n    this.getClass();\n    this.addRandomData();\n  },\n  onReachBottom: function onReachBottom() {var _this2 = this;\n    this.loadStatus = 'loading';\n    // 模拟数据加载\n    setTimeout(function () {\n      _this2.addRandomData();\n      _this2.loadStatus = 'loadmore';\n    }, 1000);\n  } };exports.default = _default;\n/* WEBPACK VAR INJECTION */}.call(this, __webpack_require__(/*! ./node_modules/@dcloudio/vue-cli-plugin-uni/lib/format-log.js */ 76)[\"default\"]))//# sourceURL=[module]\n//# sourceMappingURL=data:application/json;charset=utf-8;base64,\n//# sourceURL=webpack-internal:///75\n");
...
/* 77 */
/*!*****************************************!*\
  !*** D:/Github/zy-app/utils/storage.js ***!
  \*****************************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {
